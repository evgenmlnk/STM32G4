...
void HAL_CORDIC_MspInit(CORDIC_HandleTypeDef* cordicHandle)
{
  ...
  /* USER CODE END CORDIC_MspInit 0 */
    ...
    hdma_cordic_write.Init.Mode = DMA_CIRCULAR;
    hdma_cordic_write.Init.Priority = DMA_PRIORITY_VERY_HIGH;
    ...
    hdma_cordic_read.Init.Mode = DMA_CIRCULAR;
    hdma_cordic_read.Init.Priority = DMA_PRIORITY_VERY_HIGH;
